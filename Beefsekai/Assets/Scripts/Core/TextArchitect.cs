...
public class TextArchitect
{
	...
	private static Dictionary<TMP_Text, TextArchitect> activeArchitects = new Dictionary<TMP_Text, TextArchitect>();
	...
	public TextArchitect(TMP_Text tmpro, string targetText, string preText = "", int charactersPerFrame = 1, float speed = 1f)
	{
		this.tmpro = tmpro;
    ...
    //Renew this architect by giving it a new target display, overriding the old one.
    //Allows the same architect to be used multiple times rather than a creating a new one
